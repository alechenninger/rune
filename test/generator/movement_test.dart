      ...
      test('multiple object positions and facing', () {
        ...
        expect(
            ...
            Asm([
              ...
              // Then shay facing (using expression)
              ...
              beq.s(Label(r'.zerovector_1_Shay')),
              tst.w(d2),
              ...
              move.w(FacingDir_Down.i, d0),
              bra.s(Label(r'.keep_1_Shay')),
              label(Label('.zerovector_1_Shay')),
              // Uses a3 because we know Shay is in a3
              // No need to load into different register
